...
%	DEDICATION
%----------------------------------------------------------------------------------------
\dedicatory{\`{a} Julia et Fernanda} 
...
%----------------------------------------------------------------------------------------
\backmatter%
\addpartB{\bibname}		% start Bibiography part
\nocite{*} 				% force to cite all entries

% If you are using the separation between primary and secundary sources:
\printbibliography[heading=primary,keyword=primary]
\printbibliography[heading=secondary,keyword=secondary]
% otherwise, comment the two previously lines and uncomment the next.
